...
export class SearchComponent {
  ...
  @Event({ bubbles: false }) changeInput: EventEmitter<string>;
  ...
  render() {
    return (
      <div class="search-box">
        ...
        <input value={this.value} onInput={event => this.handleChange(event)} type="text" class="input-search" placeholder="Type to Search..." />
      </div>
    );
  }
}
